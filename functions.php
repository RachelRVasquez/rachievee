...
function rachievee_scripts() {
	...
	wp_enqueue_style( 'rachievee-main-css', get_template_directory_uri() . '/dist/css/main.min.css' );

	wp_enqueue_script( 'rachievee-main-js', get_template_directory_uri() . '/dist/js/main.min.js', [], false, true );
